...
const i18nJA = {
  ...
  'hero-intro': 'はじめまして、陳俊文（チン シュンブン）と申します。中国四川省出身です。現在、電気通信大学の柳井研究室に所属し、博士課程に在籍しています。主な研究テーマは「人物-物体インタラクション検出」および「AIGC（AI生成コンテンツ）」です。',
  'hero-contact': 'お問い合わせ',
  ...
  'about-interests-3': 'AIGC：テキストから画像生成、マルチレイヤー画像生成、画像編集',
